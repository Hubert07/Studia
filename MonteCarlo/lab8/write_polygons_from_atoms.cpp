...
void write_polygons_from_atoms(double rmax, int n, vector<vector<double>> atom, const char * plik){
	...
	neigh.resize(n,vector<int>(nemax,0));
	
	vector<vector<double>> plane_vector;
	plane_vector.resize(n,vector<double>(3,0));
